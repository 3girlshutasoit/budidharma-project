...
function databasequery($rididuserp, $rididgurup, $ksp, $dup, $pelajaranp, $nilaip){
	...
	$sql  = "
		select 	  respon,
				  pesan
		from subentitas.fentrinilaisemester	(rididuserp 	:=:rididuserp,
	...
	$cmd->bindValue(':dup', $dup, PDO::PARAM_STR);
