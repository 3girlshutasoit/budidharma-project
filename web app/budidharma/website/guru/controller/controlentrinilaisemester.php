<?php 
class entriNilaiSemester {
	public function entricontrolNilaiSemester($rididuserp, $rididgurup, $ksp, $dup, $pelajaranp, $nilaip) {
		require_once("../lib/nusoap.php");
		error_reporting(0);
		$wsdl   = "http://localhost/budidharma/serverxmladmin/subentitas/entrinilaisemester.php?wsdl";
