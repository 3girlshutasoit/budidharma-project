<?php 
class entriNilaiBulanan {
	public function entricontrolNilaiBulanan($rididuserp, $rididgurup, $ksp, $dup, $pelajaranp, $nilaip) {
		require_once("../lib/nusoap.php");
		error_reporting(0);
		$wsdl   = "http://localhost/budidharma/serverxmladmin/subentitas/entrinilaibulanan.php?wsdl";
